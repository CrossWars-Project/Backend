...
def test_update_user_stats():
    ...
    res5 = client.put("/stats/update_user_stats", json={
    ...
    res6 = client.put("/stats/update_user_stats", json={
        "user_id": MOCK_USER["id"],
    ...
    res7 = client.put("/stats/update_user_stats", json={
        "user_id": MOCK_USER["id"],
        "fastest_solo_time": 5.0
    })
    ...
    res9 = client.put("/stats/update_user_stats", json={
        "user_id": MOCK_USER["id"],
        "dt_last_seen": yesterday
    })
    assert res9.status_code == 200
    assert res9.json()["success"] is True

    # next day - should increment streak
    res10 = client.put("/stats/update_user_stats", json={
        "user_id": MOCK_USER["id"],
        "dt_last_seen": today
    })
